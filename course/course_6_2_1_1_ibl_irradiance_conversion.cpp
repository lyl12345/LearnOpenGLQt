#include "course_6_2_1_1_ibl_irradiance_conversion.h"
#include <QDir>
#include <QDebug>
#include "stb_image.h"

Course_6_2_1_1_ibl_irradiance_conversion::Course_6_2_1_1_ibl_irradiance_conversion()
    :CourseWithCamera()
    ,nrRows(7)
    ,nrColumns(7)
    ,spacing(2.5)
...
void Course_6_2_1_1_ibl_irradiance_conversion::init(GlWindow *glWindow)
{
    ...
    QString shaderPath = QDir::currentPath() + "/shaders/6.pbr/2.1.1.ibl_irradiance_conversion/";
    pbrShader.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"2.1.1.pbr.vs");
    pbrShader.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"2.1.1.pbr.fs");
    pbrShader.link();

    equirectangularToCubemapShader.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"2.1.1.cubemap.vs");
    equirectangularToCubemapShader.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"2.1.1.equirectangular_to_cubemap.fs");
    equirectangularToCubemapShader.link();

    backgroundShader.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"2.1.1.background.vs");
    backgroundShader.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"2.1.1.background.fs");
...
void Course_6_2_1_1_ibl_irradiance_conversion::render()
{
    Course::render();
...
QList<QtProperty *> Course_6_2_1_1_ibl_irradiance_conversion::getPropertyList(QtVariantPropertyManager *manager)
{
    GETPROPERTYLIST(Course_6_2_1_1_ibl_irradiance_conversion)
}

void Course_6_2_1_1_ibl_irradiance_conversion::renderSphere()
{
    if (sphereVAO == 0)
    {
...
void Course_6_2_1_1_ibl_irradiance_conversion::renderCube()
{
...
float Course_6_2_1_1_ibl_irradiance_conversion::clamp(float x, float minVal, float maxVal)
{
