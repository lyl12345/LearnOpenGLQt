#include "course_5_3_2_2_point_shadows_soft.h"
#include <QDir>
#include <QDebug>
#include "stb_image.h"

Course_5_3_2_2_point_shadows_soft::Course_5_3_2_2_point_shadows_soft()
    :CourseWithCamera()
    ,cubeVAO(0)
    ,cubeVBO(0)
    ,shadows(true)
    ,shadowsKeyPressed(false)
{
    ...
    QString shaderPath = QDir::currentPath() + "/shaders/5.advanced_lighting/3.2.2.point_shadows_soft/";
    shader.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"3.2.2.point_shadows.vs");
    shader.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"3.2.2.point_shadows.fs");
    shader.link();

    simpleDepthShader.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"3.2.2.point_shadows_depth.vs");
    simpleDepthShader.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"3.2.2.point_shadows_depth.fs");
    simpleDepthShader.addShaderFromSourceFile(QOpenGLShader::Geometry,shaderPath+"3.2.2.point_shadows_depth.gs");
...
void Course_5_3_2_2_point_shadows_soft::render()
{
    Course::render();
...
QList<QtProperty *> Course_5_3_2_2_point_shadows_soft::getPropertyList(QtVariantPropertyManager *manager)
{
    GETPROPERTYLIST(Course_5_3_2_2_point_shadows_soft)
}

void Course_5_3_2_2_point_shadows_soft::processInput()
{
...
void Course_5_3_2_2_point_shadows_soft::renderScene(QOpenGLShaderProgram &shader)
{
    // room cube
    QMatrix4x4 model;
...
void Course_5_3_2_2_point_shadows_soft::renderCube()
{
