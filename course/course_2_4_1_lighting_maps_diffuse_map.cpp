#include "course_2_4_1_lighting_maps_diffuse_map.h"
...
Course_2_4_1_lighting_maps_diffuse_map::Course_2_4_1_lighting_maps_diffuse_map()
    :CourseWithCamera()
    ,lightPos(QVector3D(1.2f, 1.0f, 2.0f))
{
    ...
    QString shaderPath = QDir::currentPath() + "/shaders/2.lighting/4.1.lighting_maps_diffuse_map/";
    mLightingProgram.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"4.1.lighting_maps.vs");
    mLightingProgram.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"4.1.lighting_maps.fs");
    mLightingProgram.link();

    mLightCubeProgram.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"4.1.light_cube.vs");
    mLightCubeProgram.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"4.1.light_cube.fs");
...
void Course_2_4_1_lighting_maps_diffuse_map::render()
{
    Course::render();
    ...
    // material properties
    mLightingProgram.setUniformValue("material.specular", 0.5f, 0.5f, 0.5f);
...
QList<QtProperty *> Course_2_4_1_lighting_maps_diffuse_map::getPropertyList(QtVariantPropertyManager *manager)
{
    GETPROPERTYLIST(Course_2_4_1_lighting_maps_diffuse_map)
}
