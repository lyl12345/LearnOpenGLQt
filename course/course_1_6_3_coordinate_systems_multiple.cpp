#include "course_1_6_3_coordinate_systems_multiple.h"
#include <QDir>
#include <QDebug>
#include "stb_image.h"

Course_1_6_3_coordinate_systems_multiple::Course_1_6_3_coordinate_systems_multiple()
{
    initializeOpenGLFunctions();

    glEnable(GL_DEPTH_TEST);
    QString shaderPath = QDir::currentPath() + "/shaders/1.getting_started/6.3.coordinate_systems_multiple/";
    mProgram = new QOpenGLShaderProgram();
    mProgram->addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"6.3.coordinate_systems.vs");
    mProgram->addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"6.3.coordinate_systems.fs");
    mProgram->link();
...
void Course_1_6_3_coordinate_systems_multiple::render()
{
    Course::render();
    ...
    mView.translate(QVector3D(0.0f, 0.0f, -3.0f));
...
QList<QtProperty *> Course_1_6_3_coordinate_systems_multiple::getPropertyList(QtVariantPropertyManager *manager)
{
    GETPROPERTYLIST(Course_1_6_3_coordinate_systems_multiple)
}
