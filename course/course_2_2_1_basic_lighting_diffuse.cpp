#include "course_2_2_1_basic_lighting_diffuse.h"
#include <QDir>
#include <QDebug>
#include "stb_image.h"
#include <QMouseEvent>
...
Course_2_2_1_basic_lighting_diffuse::Course_2_2_1_basic_lighting_diffuse()
    :CourseWithCamera()
    ,lightPos(QVector3D(1.2f, 1.0f, 2.0f))
{
    ...
    QString shaderPath = QDir::currentPath() + "/shaders/2.lighting/2.1.basic_lighting_diffuse/";
    mLightingProgram.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"2.1.basic_lighting.vs");
    mLightingProgram.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"2.1.basic_lighting.fs");
    mLightingProgram.link();

    mLightCubeProgram.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"2.1.light_cube.vs");
    mLightCubeProgram.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"2.1.light_cube.fs");
...
void Course_2_2_1_basic_lighting_diffuse::render()
{
    Course::render();
...
QList<QtProperty *> Course_2_2_1_basic_lighting_diffuse::getPropertyList(QtVariantPropertyManager *manager)
{
