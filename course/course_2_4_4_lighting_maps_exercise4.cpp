#include "course_2_4_4_lighting_maps_exercise4.h"
#include <QDir>
#include <QDebug>
#include "stb_image.h"
#include <QMouseEvent>
...
Course_2_4_4_lighting_maps_exercises4::Course_2_4_4_lighting_maps_exercises4()
    :CourseWithCamera()
    ,lightPos(QVector3D(1.2f, 1.0f, 2.0f))
{
    ...
    QString shaderPath = QDir::currentPath() + "/shaders/2.lighting/4.4.lighting_maps_exercise4/";
    mLightingProgram.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"4.4.lighting_maps.vs");
    mLightingProgram.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"4.4.lighting_maps.fs");
    mLightingProgram.link();

    mLightCubeProgram.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"4.4.light_cube.vs");
    mLightCubeProgram.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"4.4.light_cube.fs");
    ...
    texturePath = QDir::currentPath() + "/resources/textures/matrix.jpg";
    emissionMap = loadTexture(texturePath.toStdString().c_str());
    ...
    mLightingProgram.setUniformValue("material.emission", 2);
}
...
void Course_2_4_4_lighting_maps_exercises4::render()
{
    Course::render();
...
QList<QtProperty *> Course_2_4_4_lighting_maps_exercises4::getPropertyList(QtVariantPropertyManager *manager)
{
    GETPROPERTYLIST(Course_2_4_4_lighting_maps_exercises)
}
