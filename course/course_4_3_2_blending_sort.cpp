#include "course_4_3_2_blending_sort.h"
#include <QDir>
#include <QDebug>
#include "stb_image.h"
#include <vector>
...
Course_4_3_2_blending_sort::Course_4_3_2_blending_sort()
    :CourseWithCamera()
{
    ...
    QString shaderPath = QDir::currentPath() + "/shaders/4.advanced_opengl/3.2.blending_sort/";
    mProgram.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"3.2.blending.vs");
    mProgram.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"3.2.blending.fs");
    mProgram.link();
    ...
    path = QDir::currentPath() + "/resources/textures/window.png";
...
void Course_4_3_2_blending_sort::render()
{
    Course::render();
    ...
    {
        float distance = (mCamera.Position - windows[i]).length();
...
QList<QtProperty *> Course_4_3_2_blending_sort::getPropertyList(QtVariantPropertyManager *manager)
{
    GETPROPERTYLIST(Course_4_3_2_blending_sort)
}

unsigned int Course_4_3_2_blending_sort::loadTexture(const char *path,bool gammaCorrection)
{
