#include "course_4_1_1_depth_testing.h"
#include <QDir>
#include <QDebug>
#include "stb_image.h"

Course_4_1_1_depth_testing::Course_4_1_1_depth_testing()
    :CourseWithCamera()
{
    ...
    QString shaderPath = QDir::currentPath() + "/shaders/4.advanced_opengl/1.1.depth_testing/";
    mProgram.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"1.1.depth_testing.vs");
    mProgram.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"1.1.depth_testing.fs");
    mProgram.link();
...
void Course_4_1_1_depth_testing::render()
{
    Course::render();
...
QList<QtProperty *> Course_4_1_1_depth_testing::getPropertyList(QtVariantPropertyManager *manager)
{
    GETPROPERTYLIST(Course_4_1_1_depth_testing)
}
