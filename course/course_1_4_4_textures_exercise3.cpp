#include "course_1_4_4_textures_exercise3.h"
#include <QDir>
#include <QDebug>
#include "stb_image.h"

Course_1_4_4_textures_exercise3::Course_1_4_4_textures_exercise3()
{
    initializeOpenGLFunctions();

    QString shaderPath = QDir::currentPath() + "/shaders/1.getting_started/4.4.textures_exercise3/";
    mProgram = new QOpenGLShaderProgram();
    mProgram->addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"4.4.texture.vs");
    mProgram->addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"4.4.texture.fs");
    mProgram->link();
...
void Course_1_4_4_textures_exercise3::render()
{
...
QList<QtProperty *> Course_1_4_4_textures_exercise3::getPropertyList(QtVariantPropertyManager *manager)
{
    GETPROPERTYLIST(Course_1_4_4_textures_exercise3)
}
