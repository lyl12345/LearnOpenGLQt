#include "course_5_5_3_parallax_occlusion_mapping.h"
#include <QDir>
#include <QDebug>
#include "stb_image.h"

Course_5_5_3_parallax_occlusion_mapping::Course_5_5_3_parallax_occlusion_mapping()
    :CourseWithCamera()
    ,quadVAO(0)
    ,quadVBO(0)
    ,heightScale(0.1)
{
    ...
    QString shaderPath = QDir::currentPath() + "/shaders/5.advanced_lighting/5.3.parallax_occlusion_mapping/";
    shader.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"5.3.parallax_mapping.vs");
    shader.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"5.3.parallax_mapping.fs");
    shader.link();
...
void Course_5_5_3_parallax_occlusion_mapping::render()
{
    Course::render();
...
QList<QtProperty *> Course_5_5_3_parallax_occlusion_mapping::getPropertyList(QtVariantPropertyManager *manager)
{
    GETPROPERTYLIST(Course_5_5_3_parallax_occlusion_mapping)
}

void Course_5_5_3_parallax_occlusion_mapping::processInput()
{
...
void Course_5_5_3_parallax_occlusion_mapping::renderQuad()
{
    if (quadVAO == 0)
    {
        // positions
