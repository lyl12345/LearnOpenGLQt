#include "course_2_5_1_light_casters_directional.h"
#include <QDir>
#include <QDebug>
#include "stb_image.h"
#include <QMouseEvent>
...
Course_2_5_1_light_casters_directional::Course_2_5_1_light_casters_directional()
    :CourseWithCamera()
{
    ...
    QString shaderPath = QDir::currentPath() + "/shaders/2.lighting/5.1.light_casters_directional/";
    mLightingProgram.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"5.1.light_casters.vs");
    mLightingProgram.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"5.1.light_casters.fs");
    mLightingProgram.link();

    mLightCubeProgram.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"5.1.light_cube.vs");
    mLightCubeProgram.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"5.1.light_cube.fs");
...
void Course_2_5_1_light_casters_directional::render()
{
    Course::render();
    ...
    mLightingProgram.bind();
    mLightingProgram.setUniformValue("light.direction", -0.2f, -1.0f, -0.3f);
...
QList<QtProperty *> Course_2_5_1_light_casters_directional::getPropertyList(QtVariantPropertyManager *manager)
{
    GETPROPERTYLIST(Course_2_5_1_light_casters_directional)
}
