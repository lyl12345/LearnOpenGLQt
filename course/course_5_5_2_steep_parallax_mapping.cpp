#include "course_5_5_2_steep_parallax_mapping.h"
#include <QDir>
#include <QDebug>
#include "stb_image.h"

Course_5_5_2_steep_parallax_mapping::Course_5_5_2_steep_parallax_mapping()
    :CourseWithCamera()
    ,quadVAO(0)
    ,quadVBO(0)
    ,heightScale(0.1)
{
    ...
    QString shaderPath = QDir::currentPath() + "/shaders/5.advanced_lighting/5.2.steep_parallax_mapping/";
    shader.addShaderFromSourceFile(QOpenGLShader::Vertex,shaderPath+"5.2.parallax_mapping.vs");
    shader.addShaderFromSourceFile(QOpenGLShader::Fragment,shaderPath+"5.2.parallax_mapping.fs");
    shader.link();
...
void Course_5_5_2_steep_parallax_mapping::render()
{
    Course::render();
...
QList<QtProperty *> Course_5_5_2_steep_parallax_mapping::getPropertyList(QtVariantPropertyManager *manager)
{
    GETPROPERTYLIST(Course_5_5_2_steep_parallax_mapping)
}

void Course_5_5_2_steep_parallax_mapping::processInput()
{
...
void Course_5_5_2_steep_parallax_mapping::renderQuad()
{
    if (quadVAO == 0)
    {
        // positions
